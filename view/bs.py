...
def get_daily_indie_game_discounts():
    ...
    discount_list = [int(i) for i in re.findall(r"<td class=\"DIG3_14_Orange\">(.*?)\+ keys</td>", str(game_tables))]
    ...
    for game in game_detail_list:
        ...
        res_list.append({'game_id': game_id[0], 'have_card': have_card, 'discount': discount, 'buy_href': buy_href})
